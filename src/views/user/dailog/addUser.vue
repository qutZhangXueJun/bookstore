        ...
        <el-row :gutter="30">
          <el-col :span="12">
            <el-form-item prop="userName" label="账号:">
              <el-input v-model="addData.userName" placeholder="请输入账号" :disabled="isDisabled" @blur="userNameCheck"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item prop="password" label="密码">
              <el-input type="password" v-model="addData.password" placeholder="请输入密码"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="30">
          <el-col :span="12">
            <el-form-item prop="uName" label="用户名:">
              <el-input v-model="addData.uName" placeholder="请输入用户号"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="30">
          <el-col :span="12">
            <el-form-item prop="uId" label="用户Id:">
              <el-input v-model="addData.uId" placeholder="用户Id" :disabled="isDisabled"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        this.$refs.addData.validate(valid => {
          if (valid) {
            ...
            if (this.option.isDisabled === false) {
              ...
              this.loading = true
              commonAPI('updateUser', this.addData)
                .then(res => {
                  this.loading = false
                  if (res.data.data === 'OK') {
                    this.option.isShow = false
