<template>
  <div>
    ...
    <el-card class="elMain">
      <el-button type="primary" size="mini" @click="openDialog"><i class="el-icon-printer"/>&nbsp;打印</el-button><br><br>
    ...
    subBook (val, time) {
      ...
      commonAPI('addSubBook', this.subManage)
        .then(res => {
          ...
          commonAPI('updateInventtories', { inventory: total, bId: val.row.bId })
            .then(res1 => {
              this.loading = false
